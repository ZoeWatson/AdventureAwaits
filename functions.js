...
function clean_clean(list_clean){
    try{
        ...
        liAdd("testing", "function clean_clean failed");
      }
      }
...
function clean(option, list_clean){
    try{
        ...
        liAdd("testing", "function clean failed"+err.name);
      }
    }
...
function message(messageList){
    try{
        ...
        liAdd("testing", "function message failed");
      }
      }
// choice Message
function options(choiceList, i){
    try{
        ...
        // print skill
         ...
         var num = i +1;
         // print options
         liAdd("C"+num, choice+ skillString);


    }catch(err){
        liAdd("testing", "function options failed");
      }
    }
...
function what_temp_list(skill_temp0, skill_temp1, skill_temp2, skill_temp3, skill_temp4, skill_temp5, i){
    try{
        ...
        liAdd("testing", "function function options failed");
      }
}
// skill choices
function skill_choice(skill_temp){
    try{
        ...
        liAdd("testing", "function choices failed");
    }
    }
...
function win_check(){
    try{
        ...
        liAdd("testing", "function win_check failed");
      }
      }
...
function lose_check(){
    try{
        ...
        liAdd("testing", "function lose_check failed");
      }
      }
